...
**Note**: If you haven't already, make sure you're comfortable with Python's data structures (lists, sets, dictionaries, tuples) from Tutorial 0 before proceeding.
